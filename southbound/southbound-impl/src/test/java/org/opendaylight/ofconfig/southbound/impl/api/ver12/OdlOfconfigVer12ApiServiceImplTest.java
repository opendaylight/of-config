...
public class OdlOfconfigVer12ApiServiceImplTest extends OFconfigTestBase {
    ...
    public void test_handle_Flowtable() throws Exception {
        ...
        .setMaxEntries(100l).setName("test-table").setResourceId(Uri.getDefaultInstance("test-table"));
        ...
        RpcResult<Void> rpcResult = odlOfconfigVer12ApiServiceImpl.handleFlowtable(inputBuilder.build()).get();
        ...
        .setMaxEntries(100l).setName("test-table1").setResourceId(Uri.getDefaultInstance("test-table1"));
        ...
        List<String> certificates = Lists.newArrayList(flowTableList.get(0).getName(),
                flowTableList.get(1).getName());
        ...
        flowTableList = capableSwNode.getOfconfigCapableSwitchAttributes().getCapableSwitch().getResources().getFlowTable();

        assertEquals(2, flowTableList.size());
        
        certificates = Lists.newArrayList(flowTableList.get(0).getName(),
                flowTableList.get(1).getName());
        ...
        assertEquals(1,capableSwNode.getOfconfigCapableSwitchAttributes()
                .getCapableSwitch().getResources().getFlowTable().size());
        assertEquals("test-table", capableSwNode.getOfconfigCapableSwitchAttributes()
                .getCapableSwitch().getResources().getFlowTable().get(0).getName());
    ...
    public void test_handle_Controller() throws Exception {
        ...
        ctllerBuilder.setId(new OFConfigId("controller1")).setIpAddress(IpAddressBuilder.getDefaultInstance(("127.0.0.1")))
            .setKey(new ControllerKey(new OFConfigId("controller1"))).setPort(new PortNumber(6630)).setProtocol(Protocol.Tcp);
        ...
        inputBuilder.setHandleMode(HandleMode.Put).setTopoLogicalSwitchNodeId(nodeIdString).setController(controllers);
        
        RpcResult<Void> rpcResult= odlOfconfigVer12ApiServiceImpl.handleControllers(inputBuilder.build()).get();
        ...
        assertEquals(1,
                deviceCapableSwitch.getLogicalSwitches().getSwitch().get(0).getControllers().getController().size());

        assertEquals("controller1",
                deviceCapableSwitch.getLogicalSwitches().getSwitch().get(0).getControllers().getController().get(0).getId().getValue());
        ...
        assertEquals(1,
                capableSwNode.getOfconfigCapableSwitchAttributes()
                .getCapableSwitch().getLogicalSwitches().getSwitch().get(0).getControllers().getController().size());
        ...
        ctllerBuilder.setId(new OFConfigId("controller2")).setIpAddress(IpAddressBuilder.getDefaultInstance(("192.168.1.1")))
            .setKey(new ControllerKey(new OFConfigId("controller2"))).setPort(new PortNumber(6630)).setProtocol(Protocol.Tcp);
        
        controllers.add(ctllerBuilder.build());
        
        inputBuilder.setHandleMode(HandleMode.Merge).setTopoLogicalSwitchNodeId(nodeIdString).setController(controllers);
        ...
        List<org.opendaylight.yang.gen.v1.urn.onf.config.yang.rev150211.oflogicalswitchtype.controllers.Controller>  
            ctlList=  deviceCapableSwitch.getLogicalSwitches().getSwitch().get(0).getControllers().getController();
       ...
       ctlList =capableSwNode.getOfconfigCapableSwitchAttributes().getCapableSwitch().getLogicalSwitches().getSwitch().get(0).getControllers().getController();
        ...
        inputBuilder.setHandleMode(HandleMode.Delete).setTopoLogicalSwitchNodeId(nodeIdString).setController(controllers);
    ...
    public void test_handle_ExtCert() throws Exception {
        ...
        inputBuilder.setHandleMode(HandleMode.Put)
            .setTopoCapableSwitchNodeId(netconfNodeId.getValue()).setExternalCertificate(extCertificates);
    
        
        RpcResult<Void> rpcResult= odlOfconfigVer12ApiServiceImpl.handleExtCert(inputBuilder.build()).get();
        
        assertTrue(rpcResult.isSuccessful());
        
        CapableSwitch deviceCapableSwitch = this.capableSwitchRef.get();
        
        List<org.opendaylight.yang.gen.v1.urn.onf.config.yang.rev150211.capableswitchtype.resources.ExternalCertificate>  
            extCertificateList = deviceCapableSwitch.getResources().getExternalCertificate();
        
        assertEquals(1,
                extCertificateList.size());

        assertEquals("resource_1",
                extCertificateList.get(0).getResourceId().getValue());
        ...
        extCertificateList = capableSwNode.getOfconfigCapableSwitchAttributes()
                .getCapableSwitch().getResources().getExternalCertificate();
        ...
        List<String> resourceStrings = newArrayList(extCertificateList.get(0).getResourceId().getValue(),
    ...
    public void test_handle_logicSwitch() throws Exception {
        ...
        swBuilder.setId(new OFConfigId("logicalSwitch1")).setDatapathId(new DatapathIdType("00:00:7a:31:cd:91:04:40"));
        
        switchLists.add(swBuilder.build());
        
        HandleLogicSwitchInputBuilder inputBuilder = new HandleLogicSwitchInputBuilder();
        inputBuilder.setHandleMode(HandleMode.Put).setTopoCapableSwitchNodeId(netconfNodeId.getValue())
        .setSwitch(switchLists);
        
        RpcResult<Void> rpcResult= odlOfconfigVer12ApiServiceImpl.handleLogicSwitch(inputBuilder.build()).get();
        ...
        List<org.opendaylight.yang.gen.v1.urn.onf.config.yang.rev150211.capableswitchtype.logical.switches.Switch>  
            switchList = deviceCapableSwitch.getLogicalSwitches().getSwitch();
        
        assertEquals(1,
                switchList.size());

        assertEquals("logicalSwitch1",
                switchList.get(0).getId().getValue());
        ...
        switchList = capableSwNode.getOfconfigCapableSwitchAttributes()
        ...
        swBuilder.setId(new OFConfigId("logicalSwitch2")).setDatapathId(new DatapathIdType("00:00:7a:31:cd:92:04:40"));
        
        switchLists.add(swBuilder.build());
        
        inputBuilder = new HandleLogicSwitchInputBuilder();
        inputBuilder.setHandleMode(HandleMode.Merge).setTopoCapableSwitchNodeId(netconfNodeId.getValue())
        .setSwitch(switchLists);
        ...
        List<String> logicalSwitchids = newArrayList(switchList.get(0).getId().getValue(),switchList.get(1).getId().getValue());
        ...
        logicalSwitchids = newArrayList(switchList.get(0).getId().getValue(),switchList.get(1).getId().getValue());
        ...
        inputBuilder = new HandleLogicSwitchInputBuilder();
        inputBuilder.setHandleMode(HandleMode.Delete).setTopoCapableSwitchNodeId(netconfNodeId.getValue())
        .setSwitch(switchLists);
