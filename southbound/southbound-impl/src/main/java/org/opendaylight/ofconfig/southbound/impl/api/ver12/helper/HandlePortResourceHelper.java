 ...
 *
 */
public class HandlePortResourceHelper extends AbstractOfconfigVer12HandlerHelper<HandlePortResourceInput>{
    ...
    CapableSwitch mergeCapableSwitch(CapableSwitch capableSwitch,
        ...
        for(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.ofconfig.ver12.api.types.rev150901.ofconfig_port_resource.Port paramPort: request.getPort()){
            ...
            builder.setConfiguration(paramPort.getConfiguration()).setCurrentRate(paramPort.getCurrentRate())
            .setFeatures(paramPort.getFeatures()).setKey(new PortKey(paramPort.getName())).setMaxRate(paramPort.getMaxRate())
            .setName(paramPort.getName()).setNumber(paramPort.getNumber()).setRequestedNumber(paramPort.getRequestedNumber())
