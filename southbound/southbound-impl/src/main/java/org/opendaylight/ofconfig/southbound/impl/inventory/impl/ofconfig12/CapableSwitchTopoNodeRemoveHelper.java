 ...
 *
 */
public class CapableSwitchTopoNodeRemoveHelper {

    public void removeCapableSwitchTopoNodeAttributes(NodeId nodeId,
            WriteTransaction invTopoWriteTx) {
        
        //capable switch node id equal netconfig node id
