...
public class OfconfigSouthboundImplHelper {
    ...
    List<NodeId> getAllNetconfNodeIds(){
        ...
        InstanceIdentifier<Topology> path = InstanceIdentifier
                ...
                .child(Topology.class, new TopologyKey(new TopologyId(OfconfigConstants.NETCONF_TOPOLOGY_ID)));
   ...
   Optional<OfconfigInventoryTopoHandler> getOfconfigInventoryTopoHandler(NodeId netconfNodeId) {
        ...
        NetconfNode  nnode = mdsalUtils.read(LogicalDatastoreType.OPERATIONAL, path, dataBroker).getAugmentation(NetconfNode.class);
        ...
        if(nnode!=null){
            ...
            if (Iterables.contains(capabilities, OfconfigConstants.OF_CONFIG_VERSION_12_CAPABILITY)
                ...
                return Optional.of(OfconfigInventoryTopoHandler.getHandlerInstance(OfconfigConstants.OF_CONFIG_VERSION_12_CAPABILITY));
            }
        }
